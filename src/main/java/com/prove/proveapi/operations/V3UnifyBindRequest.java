...
public class V3UnifyBindRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends com.prove.proveapi.models.components.V3UnifyBindRequest>, V3UnifyBindRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(Optional<? extends com.prove.proveapi.models.components.V3UnifyBindRequest> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends com.prove.proveapi.models.components.V3UnifyBindRequest>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends com.prove.proveapi.models.components.V3UnifyBindRequest> request) throws Exception {
        ...
        @Override
        public V3UnifyBindRequestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3UnifyBindRequestResponse.Builder resBuilder =
            ...
            V3UnifyBindRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V3UnifyBindResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3UnifyBindResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Optional<? extends com.prove.proveapi.models.components.V3UnifyBindRequest>, com.prove.proveapi.models.operations.async.V3UnifyBindRequestResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(Optional<? extends com.prove.proveapi.models.components.V3UnifyBindRequest> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends com.prove.proveapi.models.components.V3UnifyBindRequest>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Optional<? extends com.prove.proveapi.models.components.V3UnifyBindRequest> request) {
        ...
        @Override
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3UnifyBindRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.prove.proveapi.models.operations.async.V3UnifyBindRequestResponse.Builder resBuilder =
                    com.prove.proveapi.models.operations.async.V3UnifyBindRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.prove.proveapi.models.operations.async.V3UnifyBindRequestResponse res = resBuilder.build();
