...
public class V3UnifyBindRequest {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(Optional<? extends com.prove.proveapi.models.components.V3UnifyBindRequest> request) throws Exception {
            ...
            Object convertedRequest = Utils.convertToShape(
                    request,
                    JsonShape.DEFAULT,
                    new TypeReference<Optional<? extends com.prove.proveapi.models.components.V3UnifyBindRequest>>() {
                    });
