...
public class V3ActivateIdentity {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ActivateIdentityRequest request) {
        ...
        @Override
        public V3ActivateIdentityResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3ActivateIdentityResponse(Utils.unmarshal(response, new TypeReference<com.prove.proveapi.models.components.V3ActivateIdentityResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3ActivateIdentityResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.prove.proveapi.models.components.V3ActivateIdentityResponse>() {})
                            .thenApply(res::withV3ActivateIdentityResponse);
                } else {
