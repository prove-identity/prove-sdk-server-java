...
import com.prove.proveapi.models.operations.V3ActivateIdentityRequest;
...
public class V3ActivateIdentity {
    ...
    public static class Sync extends Base
            implements RequestOperation<V3ActivateIdentityRequest, V3ActivateIdentityResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(V3ActivateIdentityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3ActivateIdentityRequest.class, new TypeReference<V3ActivateIdentityRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3ActivateIdentityRequest request) throws Exception {
        ...
        @Override
        public V3ActivateIdentityResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3ActivateIdentityResponse.Builder resBuilder =
            ...
            V3ActivateIdentityResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.prove.proveapi.models.components.V3ActivateIdentityResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3ActivateIdentityResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<V3ActivateIdentityRequest, com.prove.proveapi.models.operations.async.V3ActivateIdentityResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(V3ActivateIdentityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3ActivateIdentityRequest.class, new TypeReference<V3ActivateIdentityRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(V3ActivateIdentityRequest request) {
        ...
        @Override
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3ActivateIdentityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.prove.proveapi.models.operations.async.V3ActivateIdentityResponse.Builder resBuilder =
                    com.prove.proveapi.models.operations.async.V3ActivateIdentityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.prove.proveapi.models.operations.async.V3ActivateIdentityResponse res = resBuilder.build();
