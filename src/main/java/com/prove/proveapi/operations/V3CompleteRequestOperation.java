...
public class V3CompleteRequestOperation implements RequestOperation<Optional<? extends V3CompleteRequest>, V3CompleteRequestResponse> {
    ...
    public V3CompleteRequestOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(Optional<? extends V3CompleteRequest> request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(Optional<? extends V3CompleteRequest> request) throws Exception {
