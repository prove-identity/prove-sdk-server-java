...
public class V3UnifyStatusRequest {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends com.prove.proveapi.models.components.V3UnifyStatusRequest> request) throws Exception {
        ...
        @Override
        public V3UnifyStatusRequestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V3UnifyStatusResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3UnifyStatusResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
