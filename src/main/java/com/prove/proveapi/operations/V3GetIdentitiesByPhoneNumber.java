...
public class V3GetIdentitiesByPhoneNumber {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(V3GetIdentitiesByPhoneNumberRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3GetIdentitiesByPhoneNumberRequest.class);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<V3GetIdentitiesByPhoneNumberRequest, com.prove.proveapi.models.operations.async.V3GetIdentitiesByPhoneNumberResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(V3GetIdentitiesByPhoneNumberRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3GetIdentitiesByPhoneNumberRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(V3GetIdentitiesByPhoneNumberRequest request) {
        ...
        @Override
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3GetIdentitiesByPhoneNumberResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.prove.proveapi.models.operations.async.V3GetIdentitiesByPhoneNumberResponse.Builder resBuilder =
                    com.prove.proveapi.models.operations.async.V3GetIdentitiesByPhoneNumberResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.prove.proveapi.models.operations.async.V3GetIdentitiesByPhoneNumberResponse res = resBuilder.build();
