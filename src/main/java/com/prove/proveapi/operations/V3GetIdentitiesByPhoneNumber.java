...
public class V3GetIdentitiesByPhoneNumber {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3GetIdentitiesByPhoneNumberRequest request) {
        ...
        @Override
        public V3GetIdentitiesByPhoneNumberResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3GetIdentitiesByPhoneNumberResponse(Utils.unmarshal(response, new TypeReference<com.prove.proveapi.models.components.V3GetIdentitiesByPhoneNumberResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3GetIdentitiesByPhoneNumberResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.prove.proveapi.models.components.V3GetIdentitiesByPhoneNumberResponse>() {})
                            .thenApply(res::withV3GetIdentitiesByPhoneNumberResponse);
                } else {
