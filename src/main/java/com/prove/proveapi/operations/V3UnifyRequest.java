...
public class V3UnifyRequest {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends com.prove.proveapi.models.components.V3UnifyRequest> request) {
        ...
        @Override
        public V3UnifyRequestResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3UnifyResponse(Utils.unmarshal(response, new TypeReference<V3UnifyResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3UnifyRequestResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<V3UnifyResponse>() {})
                            .thenApply(res::withV3UnifyResponse);
                } else {
