...
public class V3VerifyRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends com.prove.proveapi.models.components.V3VerifyRequest>, V3VerifyRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(Optional<? extends com.prove.proveapi.models.components.V3VerifyRequest> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends com.prove.proveapi.models.components.V3VerifyRequest>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends com.prove.proveapi.models.components.V3VerifyRequest> request) throws Exception {
        ...
        @Override
        public V3VerifyRequestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3VerifyRequestResponse.Builder resBuilder =
            ...
            V3VerifyRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V3VerifyResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3VerifyResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Optional<? extends com.prove.proveapi.models.components.V3VerifyRequest>, com.prove.proveapi.models.operations.async.V3VerifyRequestResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(Optional<? extends com.prove.proveapi.models.components.V3VerifyRequest> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends com.prove.proveapi.models.components.V3VerifyRequest>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Optional<? extends com.prove.proveapi.models.components.V3VerifyRequest> request) {
        ...
        @Override
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3VerifyRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.prove.proveapi.models.operations.async.V3VerifyRequestResponse.Builder resBuilder =
                    com.prove.proveapi.models.operations.async.V3VerifyRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.prove.proveapi.models.operations.async.V3VerifyRequestResponse res = resBuilder.build();
