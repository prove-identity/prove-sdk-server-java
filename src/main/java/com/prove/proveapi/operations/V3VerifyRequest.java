...
public class V3VerifyRequest {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(Optional<? extends com.prove.proveapi.models.components.V3VerifyRequest> request) throws Exception {
            ...
            Object convertedRequest = Utils.convertToShape(
                    request,
                    JsonShape.DEFAULT,
                    new TypeReference<Optional<? extends com.prove.proveapi.models.components.V3VerifyRequest>>() {
                    });
