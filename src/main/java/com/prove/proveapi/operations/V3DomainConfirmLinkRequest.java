...
public class V3DomainConfirmLinkRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends com.prove.proveapi.models.components.V3DomainConfirmLinkRequest>, V3DomainConfirmLinkRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(Optional<? extends com.prove.proveapi.models.components.V3DomainConfirmLinkRequest> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends com.prove.proveapi.models.components.V3DomainConfirmLinkRequest>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends com.prove.proveapi.models.components.V3DomainConfirmLinkRequest> request) throws Exception {
        ...
        @Override
        public V3DomainConfirmLinkRequestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3DomainConfirmLinkRequestResponse.Builder resBuilder =
            ...
            V3DomainConfirmLinkRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V3DomainConfirmLinkResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3DomainConfirmLinkResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Optional<? extends com.prove.proveapi.models.components.V3DomainConfirmLinkRequest>, com.prove.proveapi.models.operations.async.V3DomainConfirmLinkRequestResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(Optional<? extends com.prove.proveapi.models.components.V3DomainConfirmLinkRequest> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends com.prove.proveapi.models.components.V3DomainConfirmLinkRequest>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Optional<? extends com.prove.proveapi.models.components.V3DomainConfirmLinkRequest> request) {
        ...
        @Override
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3DomainConfirmLinkRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.prove.proveapi.models.operations.async.V3DomainConfirmLinkRequestResponse.Builder resBuilder =
                    com.prove.proveapi.models.operations.async.V3DomainConfirmLinkRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.prove.proveapi.models.operations.async.V3DomainConfirmLinkRequestResponse res = resBuilder.build();
