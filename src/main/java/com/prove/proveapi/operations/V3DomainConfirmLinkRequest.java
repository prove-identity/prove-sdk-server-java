...
public class V3DomainConfirmLinkRequest {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends com.prove.proveapi.models.components.V3DomainConfirmLinkRequest> request) {
        ...
        @Override
        public V3DomainConfirmLinkRequestResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3DomainConfirmLinkResponse(Utils.unmarshal(response, new TypeReference<V3DomainConfirmLinkResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3DomainConfirmLinkRequestResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<V3DomainConfirmLinkResponse>() {})
                            .thenApply(res::withV3DomainConfirmLinkResponse);
                } else {
