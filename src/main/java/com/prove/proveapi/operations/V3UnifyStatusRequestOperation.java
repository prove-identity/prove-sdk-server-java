...
public class V3UnifyStatusRequestOperation implements RequestOperation<Optional<? extends V3UnifyStatusRequest>, V3UnifyStatusRequestResponse> {
    ...
    public V3UnifyStatusRequestOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(Optional<? extends V3UnifyStatusRequest> request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(Optional<? extends V3UnifyStatusRequest> request) throws Exception {
