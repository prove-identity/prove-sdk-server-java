...
public class V3DeactivateIdentity {
    ...
    public static class Sync extends Base
            implements RequestOperation<V3DeactivateIdentityRequest, V3DeactivateIdentityResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(V3DeactivateIdentityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3DeactivateIdentityRequest.class, new TypeReference<V3DeactivateIdentityRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3DeactivateIdentityRequest request) throws Exception {
        ...
        @Override
        public V3DeactivateIdentityResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3DeactivateIdentityResponse.Builder resBuilder =
            ...
            V3DeactivateIdentityResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.prove.proveapi.models.components.V3DeactivateIdentityResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3DeactivateIdentityResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<V3DeactivateIdentityRequest, com.prove.proveapi.models.operations.async.V3DeactivateIdentityResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(V3DeactivateIdentityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3DeactivateIdentityRequest.class, new TypeReference<V3DeactivateIdentityRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(V3DeactivateIdentityRequest request) {
        ...
        @Override
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3DeactivateIdentityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.prove.proveapi.models.operations.async.V3DeactivateIdentityResponse.Builder resBuilder =
                    com.prove.proveapi.models.operations.async.V3DeactivateIdentityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.prove.proveapi.models.operations.async.V3DeactivateIdentityResponse res = resBuilder.build();
