...
public class V3FetchRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<V3FetchRequestRequest, V3FetchRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(V3FetchRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3FetchRequestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3FetchRequestRequest request) {
        ...
        @Override
        public V3FetchRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3FetchRequestResponse.Builder resBuilder =
            ...
            V3FetchRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<V3FetchRequestRequest, com.prove.proveapi.models.operations.async.V3FetchRequestResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(V3FetchRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3FetchRequestRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(V3FetchRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3FetchRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.prove.proveapi.models.operations.async.V3FetchRequestResponse.Builder resBuilder =
                    com.prove.proveapi.models.operations.async.V3FetchRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.prove.proveapi.models.operations.async.V3FetchRequestResponse res = resBuilder.build();
