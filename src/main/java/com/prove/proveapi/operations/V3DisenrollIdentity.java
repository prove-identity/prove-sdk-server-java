...
public class V3DisenrollIdentity {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3DisenrollIdentityRequest request) {
        ...
        @Override
        public V3DisenrollIdentityResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3DisenrollIdentityResponse(Utils.unmarshal(response, new TypeReference<com.prove.proveapi.models.components.V3DisenrollIdentityResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3DisenrollIdentityResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.prove.proveapi.models.components.V3DisenrollIdentityResponse>() {})
                            .thenApply(res::withV3DisenrollIdentityResponse);
                } else {
