...
public class V3DisenrollIdentity {
    ...
    public static class Sync extends Base
            implements RequestOperation<V3DisenrollIdentityRequest, V3DisenrollIdentityResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(V3DisenrollIdentityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3DisenrollIdentityRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3DisenrollIdentityRequest request) throws Exception {
        ...
        @Override
        public V3DisenrollIdentityResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3DisenrollIdentityResponse.Builder resBuilder =
            ...
            V3DisenrollIdentityResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.prove.proveapi.models.components.V3DisenrollIdentityResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3DisenrollIdentityResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<V3DisenrollIdentityRequest, com.prove.proveapi.models.operations.async.V3DisenrollIdentityResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(V3DisenrollIdentityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3DisenrollIdentityRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(V3DisenrollIdentityRequest request) {
        ...
        @Override
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3DisenrollIdentityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.prove.proveapi.models.operations.async.V3DisenrollIdentityResponse.Builder resBuilder =
                    com.prove.proveapi.models.operations.async.V3DisenrollIdentityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.prove.proveapi.models.operations.async.V3DisenrollIdentityResponse res = resBuilder.build();
