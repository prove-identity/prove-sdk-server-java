...
public class V3VerifyRequestOperation implements RequestOperation<Optional<? extends V3VerifyRequest>, V3VerifyRequestResponse> {
    ...
    public V3VerifyRequestOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(Optional<? extends V3VerifyRequest> request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(Optional<? extends V3VerifyRequest> request) throws Exception {
