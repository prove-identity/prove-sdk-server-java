...
public class V3VerifyStatusRequestOperation implements RequestOperation<Optional<? extends V3VerifyStatusRequest>, V3VerifyStatusRequestResponse> {
    ...
    public V3VerifyStatusRequestOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(Optional<? extends V3VerifyStatusRequest> request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(Optional<? extends V3VerifyStatusRequest> request) throws Exception {
