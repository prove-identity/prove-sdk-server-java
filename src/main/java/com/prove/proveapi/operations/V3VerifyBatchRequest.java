...
public class V3VerifyBatchRequest {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends com.prove.proveapi.models.components.V3VerifyBatchRequest> request) {
        ...
        @Override
        public V3VerifyBatchRequestResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3VerifyBatchResponse(Utils.unmarshal(response, new TypeReference<V3VerifyBatchResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3VerifyBatchRequestResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<V3VerifyBatchResponse>() {})
                            .thenApply(res::withV3VerifyBatchResponse);
                } else {
