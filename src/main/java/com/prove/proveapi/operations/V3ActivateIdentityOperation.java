...
public class V3ActivateIdentityOperation implements RequestOperation<V3ActivateIdentityRequest, V3ActivateIdentityResponse> {
    ...
    public V3ActivateIdentityOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(V3ActivateIdentityRequest request) throws Exception {
        String url = Utils.generateURL(
                V3ActivateIdentityRequest.class,
                this.baseUrl,
