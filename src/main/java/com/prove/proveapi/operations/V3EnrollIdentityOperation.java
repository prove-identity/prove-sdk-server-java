...
public class V3EnrollIdentityOperation implements RequestOperation<Optional<? extends V3EnrollIdentityRequest>, V3EnrollIdentityResponse> {
    ...
    public V3EnrollIdentityOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(Optional<? extends V3EnrollIdentityRequest> request) throws Exception {
