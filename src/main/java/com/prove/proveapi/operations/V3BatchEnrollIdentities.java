...
public class V3BatchEnrollIdentities {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends V3BatchEnrollIdentitiesRequest> request) {
        ...
        @Override
        public V3BatchEnrollIdentitiesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3BatchEnrollIdentitiesResponse(Utils.unmarshal(response, new TypeReference<com.prove.proveapi.models.components.V3BatchEnrollIdentitiesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3BatchEnrollIdentitiesResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.prove.proveapi.models.components.V3BatchEnrollIdentitiesResponse>() {})
                            .thenApply(res::withV3BatchEnrollIdentitiesResponse);
                } else {
