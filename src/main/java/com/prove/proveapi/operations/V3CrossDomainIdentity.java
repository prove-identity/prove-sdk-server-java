...
import com.prove.proveapi.models.operations.V3CrossDomainIdentityRequest;
...
public class V3CrossDomainIdentity {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/v3/identity/{identityId}/cross-domain",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<V3CrossDomainIdentityRequest, V3CrossDomainIdentityResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(V3CrossDomainIdentityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3CrossDomainIdentityRequest.class, new TypeReference<V3CrossDomainIdentityRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3CrossDomainIdentityRequest request) throws Exception {
        ...
        @Override
        public V3CrossDomainIdentityResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3CrossDomainIdentityResponse.Builder resBuilder =
            ...
            V3CrossDomainIdentityResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    com.prove.proveapi.models.components.V3CrossDomainIdentityResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3CrossDomainIdentityResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<V3CrossDomainIdentityRequest, com.prove.proveapi.models.operations.async.V3CrossDomainIdentityResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(V3CrossDomainIdentityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, V3CrossDomainIdentityRequest.class, new TypeReference<V3CrossDomainIdentityRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(V3CrossDomainIdentityRequest request) {
        ...
        @Override
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3CrossDomainIdentityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.prove.proveapi.models.operations.async.V3CrossDomainIdentityResponse.Builder resBuilder =
                    com.prove.proveapi.models.operations.async.V3CrossDomainIdentityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.prove.proveapi.models.operations.async.V3CrossDomainIdentityResponse res = resBuilder.build();
