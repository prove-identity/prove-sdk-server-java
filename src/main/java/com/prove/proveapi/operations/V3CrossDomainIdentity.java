...
public class V3CrossDomainIdentity {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(V3CrossDomainIdentityRequest request) {
        ...
        @Override
        public V3CrossDomainIdentityResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3CrossDomainIdentityResponse(Utils.unmarshal(response, new TypeReference<com.prove.proveapi.models.components.V3CrossDomainIdentityResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3CrossDomainIdentityResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.prove.proveapi.models.components.V3CrossDomainIdentityResponse>() {})
                            .thenApply(res::withV3CrossDomainIdentityResponse);
                } else {
