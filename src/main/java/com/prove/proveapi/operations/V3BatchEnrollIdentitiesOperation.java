...
public class V3BatchEnrollIdentitiesOperation implements RequestOperation<Optional<? extends V3BatchEnrollIdentitiesRequest>, V3BatchEnrollIdentitiesResponse> {
    ...
    public V3BatchEnrollIdentitiesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(Optional<? extends V3BatchEnrollIdentitiesRequest> request) throws Exception {
