...
public class V3UnifyBindRequestOperation implements RequestOperation<Optional<? extends V3UnifyBindRequest>, V3UnifyBindRequestResponse> {
    ...
    public V3UnifyBindRequestOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(Optional<? extends V3UnifyBindRequest> request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(Optional<? extends V3UnifyBindRequest> request) throws Exception {
