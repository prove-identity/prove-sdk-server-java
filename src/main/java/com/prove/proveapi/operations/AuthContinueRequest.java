...
public class AuthContinueRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends com.prove.proveapi.models.components.AuthContinueRequest>, AuthContinueRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(Optional<? extends com.prove.proveapi.models.components.AuthContinueRequest> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends com.prove.proveapi.models.components.AuthContinueRequest>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends com.prove.proveapi.models.components.AuthContinueRequest> request) {
        ...
        @Override
        public AuthContinueRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AuthContinueRequestResponse.Builder resBuilder =
            ...
            AuthContinueRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAuthContinueResponse(Utils.unmarshal(response, new TypeReference<AuthContinueResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Optional<? extends com.prove.proveapi.models.components.AuthContinueRequest>, com.prove.proveapi.models.operations.async.AuthContinueRequestResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(Optional<? extends com.prove.proveapi.models.components.AuthContinueRequest> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Optional<? extends com.prove.proveapi.models.components.AuthContinueRequest>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Optional<? extends com.prove.proveapi.models.components.AuthContinueRequest> request) {
        ...
        @Override
        public CompletableFuture<com.prove.proveapi.models.operations.async.AuthContinueRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.prove.proveapi.models.operations.async.AuthContinueRequestResponse.Builder resBuilder =
                    com.prove.proveapi.models.operations.async.AuthContinueRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.prove.proveapi.models.operations.async.AuthContinueRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AuthContinueResponse>() {})
                            .thenApply(res::withAuthContinueResponse);
                } else {
