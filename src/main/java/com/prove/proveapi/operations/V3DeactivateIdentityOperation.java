...
public class V3DeactivateIdentityOperation implements RequestOperation<V3DeactivateIdentityRequest, V3DeactivateIdentityResponse> {
    ...
    public V3DeactivateIdentityOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(V3DeactivateIdentityRequest request) throws Exception {
