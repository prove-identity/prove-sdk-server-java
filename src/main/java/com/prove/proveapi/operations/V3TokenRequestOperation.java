...
public class V3TokenRequestOperation implements RequestOperation<Optional<? extends V3TokenRequest>, V3TokenRequestResponse> {
    ...
    public V3TokenRequestOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(Optional<? extends V3TokenRequest> request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(Optional<? extends V3TokenRequest> request) throws Exception {
