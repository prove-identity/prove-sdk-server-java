...
public class V3StartRequestOperation implements RequestOperation<Optional<? extends V3StartRequest>, V3StartRequestResponse> {
    ...
    public V3StartRequestOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(Optional<? extends V3StartRequest> request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(Optional<? extends V3StartRequest> request) throws Exception {
