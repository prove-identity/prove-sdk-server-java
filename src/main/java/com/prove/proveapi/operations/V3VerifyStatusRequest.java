...
public class V3VerifyStatusRequest {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(Optional<? extends com.prove.proveapi.models.components.V3VerifyStatusRequest> request) throws Exception {
            ...
            Object convertedRequest = Utils.convertToShape(
                    request,
                    JsonShape.DEFAULT,
                    new TypeReference<Optional<? extends com.prove.proveapi.models.components.V3VerifyStatusRequest>>() {
                    });
    ...
    public static class Sync extends Base
            implements RequestOperation<Optional<? extends com.prove.proveapi.models.components.V3VerifyStatusRequest>, V3VerifyStatusRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(Optional<? extends com.prove.proveapi.models.components.V3VerifyStatusRequest> request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends com.prove.proveapi.models.components.V3VerifyStatusRequest> request) throws Exception {
        ...
        @Override
        public V3VerifyStatusRequestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            V3VerifyStatusRequestResponse.Builder resBuilder =
            ...
            V3VerifyStatusRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    V3VerifyStatusResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withV3VerifyStatusResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
