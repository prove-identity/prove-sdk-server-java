...
public class V3DomainIDRequest {
    ...
    public static class Sync extends Base
        ...
        @Override
        public V3DomainIDRequestResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3DomainIDResponse(Utils.unmarshal(response, new TypeReference<V3DomainIDResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<com.prove.proveapi.models.operations.async.V3DomainIDRequestResponse> {
        ...
        @Override
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3DomainIDRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.prove.proveapi.models.operations.async.V3DomainIDRequestResponse.Builder resBuilder =
                    com.prove.proveapi.models.operations.async.V3DomainIDRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.prove.proveapi.models.operations.async.V3DomainIDRequestResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<V3DomainIDResponse>() {})
                            .thenApply(res::withV3DomainIDResponse);
                } else {
