...
public class V3ChallengeRequestOperation implements RequestOperation<Optional<? extends V3ChallengeRequest>, V3ChallengeRequestResponse> {
    ...
    public V3ChallengeRequestOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(Optional<? extends V3ChallengeRequest> request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(Optional<? extends V3ChallengeRequest> request) throws Exception {
