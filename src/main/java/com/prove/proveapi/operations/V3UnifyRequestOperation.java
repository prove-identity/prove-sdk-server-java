...
public class V3UnifyRequestOperation implements RequestOperation<Optional<? extends V3UnifyRequest>, V3UnifyRequestResponse> {
    ...
    public V3UnifyRequestOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(Optional<? extends V3UnifyRequest> request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(Optional<? extends V3UnifyRequest> request) throws Exception {
