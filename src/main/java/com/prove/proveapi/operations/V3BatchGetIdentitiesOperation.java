...
public class V3BatchGetIdentitiesOperation implements RequestOperation<V3BatchGetIdentitiesRequest, V3BatchGetIdentitiesResponse> {
    ...
    public V3BatchGetIdentitiesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(V3BatchGetIdentitiesRequest request) throws Exception {
