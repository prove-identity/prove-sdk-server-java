...
public class V3ValidateRequest {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Optional<? extends com.prove.proveapi.models.components.V3ValidateRequest> request) {
        ...
        @Override
        public V3ValidateRequestResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withV3ValidateResponse(Utils.unmarshal(response, new TypeReference<V3ValidateResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.prove.proveapi.models.operations.async.V3ValidateRequestResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<V3ValidateResponse>() {})
                            .thenApply(res::withV3ValidateResponse);
                } else {
