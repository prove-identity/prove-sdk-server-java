...
public class V3DisenrollIdentityOperation implements RequestOperation<V3DisenrollIdentityRequest, V3DisenrollIdentityResponse> {
    ...
    public V3DisenrollIdentityOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(V3DisenrollIdentityRequest request) throws Exception {
