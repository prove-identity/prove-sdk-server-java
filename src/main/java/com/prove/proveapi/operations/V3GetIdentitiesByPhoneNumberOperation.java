...
public class V3GetIdentitiesByPhoneNumberOperation implements RequestOperation<V3GetIdentitiesByPhoneNumberRequest, V3GetIdentitiesByPhoneNumberResponse> {
    ...
    public V3GetIdentitiesByPhoneNumberOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(V3GetIdentitiesByPhoneNumberRequest request) throws Exception {
