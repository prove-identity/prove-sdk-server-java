...
public class V3ValidateRequestOperation implements RequestOperation<Optional<? extends V3ValidateRequest>, V3ValidateRequestResponse> {
    ...
    public V3ValidateRequestOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(Optional<? extends V3ValidateRequest> request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(Optional<? extends V3ValidateRequest> request) throws Exception {
