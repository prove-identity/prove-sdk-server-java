...
public class V3UnifyBindRequest {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        V3UnifyBindRequest other = (V3UnifyBindRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(V3UnifyBindRequest.class,
    ...
    public final static class Builder {
        ...
        public V3UnifyBindRequest build() {

            return new V3UnifyBindRequest(
                clientRequestId, correlationId, phoneNumber);
        }
