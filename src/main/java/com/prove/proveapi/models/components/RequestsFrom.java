...
public class RequestsFrom {
    ...
    public RequestsFrom withName(String name) {
        Utils.checkNotNull(name, "name");
    ...
    public RequestsFrom withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }

    public RequestsFrom withPcid(String pcid) {
        Utils.checkNotNull(pcid, "pcid");
    ...
    public RequestsFrom withPcid(Optional<String> pcid) {
        Utils.checkNotNull(pcid, "pcid");
        this.pcid = pcid;
        return this;
    }

    public RequestsFrom withRequestedAt(long requestedAt) {
        Utils.checkNotNull(requestedAt, "requestedAt");
    ...
    public RequestsFrom withRequestedAt(Optional<Long> requestedAt) {
        Utils.checkNotNull(requestedAt, "requestedAt");
        this.requestedAt = requestedAt;
        return this;
    }

    public RequestsFrom withRequestedString(String requestedString) {
        Utils.checkNotNull(requestedString, "requestedString");
    ...
    public RequestsFrom withRequestedString(Optional<String> requestedString) {
        Utils.checkNotNull(requestedString, "requestedString");
        this.requestedString = requestedString;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RequestsFrom other = (RequestsFrom) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RequestsFrom.class,
                "name", name,
                "pcid", pcid,
