...
public class Error401 extends ProveapiError {
    ...
    /**
    * Parse a response into an instance of Error401. If deserialization of the response body fails,
    ...
    */
    ...
    /**
    * Parse a response into an instance of Error401 asynchronously. If deserialization of the response body fails,
    * the resulting Error401 instance will have a null data() value and a non-null deserializationException().
    */
    public static CompletableFuture<Error401> fromAsync(HttpResponse<Blob> response) {
