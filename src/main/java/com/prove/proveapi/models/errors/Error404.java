...
public class Error404 extends ProveapiError {
    ...
    /**
    * Parse a response into an instance of Error404. If deserialization of the response body fails,
    * the resulting Error404 instance will have a null data() value and a non-null deserializationException().
    */
    public static Error404 from(HttpResponse<InputStream> response) {
        byte[] bytes;
        try {
            bytes = Utils.extractByteArrayFromBody(response);
        } catch (Exception e) {
            return new Error404(response.statusCode(), null, response, null, e);
        }
        try {
            Data data = Utils.mapper().readValue(bytes, Data.class);
            return new Error404(response.statusCode(), bytes, response, data, null);
        } catch (Exception e) {
            return new Error404(response.statusCode(), bytes, response, null, e);
        }
    }

    /**
    * Parse a response into an instance of Error404 asynchronously. If deserialization of the response body fails,
    * the resulting Error404 instance will have a null data() value and a non-null deserializationException().
    */
    public static CompletableFuture<Error404> fromAsync(HttpResponse<Blob> response) {
