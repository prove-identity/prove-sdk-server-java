...
public final class SDKHooks {
    ...
    public static void initialize(com.prove.proveapi.utils.Hooks hooks) {
    ...
    public static void initialize(com.prove.proveapi.utils.AsyncHooks asyncHooks) {
        ...
        // asyncHooks.registerAfterError(com.prove.proveapi.utils.HookAdapters.adapt(mySyncHook));
