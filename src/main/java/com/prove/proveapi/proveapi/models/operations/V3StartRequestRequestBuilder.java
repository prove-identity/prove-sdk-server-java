...
public class V3StartRequestRequestBuilder {
    ...
    private Optional<? extends com.prove.proveapi.proveapi.models.components.V3StartRequest> request = Optional.empty();
    ...
    public V3StartRequestRequestBuilder request(com.prove.proveapi.proveapi.models.components.V3StartRequest request) {
        Utils.checkNotNull(request, "request");
        this.request = Optional.of(request);
        return this;
    }

    public V3StartRequestRequestBuilder request(Optional<? extends com.prove.proveapi.proveapi.models.components.V3StartRequest> request) {
        Utils.checkNotNull(request, "request");
