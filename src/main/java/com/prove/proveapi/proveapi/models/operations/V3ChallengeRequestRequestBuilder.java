...
public class V3ChallengeRequestRequestBuilder {
    ...
    private Optional<? extends com.prove.proveapi.proveapi.models.components.V3ChallengeRequest> request = Optional.empty();
    ...
    public V3ChallengeRequestRequestBuilder request(com.prove.proveapi.proveapi.models.components.V3ChallengeRequest request) {
        Utils.checkNotNull(request, "request");
        this.request = Optional.of(request);
        return this;
    }

    public V3ChallengeRequestRequestBuilder request(Optional<? extends com.prove.proveapi.proveapi.models.components.V3ChallengeRequest> request) {
        Utils.checkNotNull(request, "request");
