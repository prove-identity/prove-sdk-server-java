...
public class V3CompleteRequestRequestBuilder {
    ...
    private Optional<? extends com.prove.proveapi.proveapi.models.components.V3CompleteRequest> request = Optional.empty();
    ...
    public V3CompleteRequestRequestBuilder request(com.prove.proveapi.proveapi.models.components.V3CompleteRequest request) {
        Utils.checkNotNull(request, "request");
        this.request = Optional.of(request);
        return this;
    }

    public V3CompleteRequestRequestBuilder request(Optional<? extends com.prove.proveapi.proveapi.models.components.V3CompleteRequest> request) {
        Utils.checkNotNull(request, "request");
