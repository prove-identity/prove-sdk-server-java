...
import com.prove.proveapi.proveapi.utils.SpeakeasyHTTPClient;
...
public class Proveapi {
    ...
    public static class Builder {
        ...
        public Builder auth(String auth) {
            this.sdkConfiguration.securitySource = SecuritySource.of(com.prove.proveapi.proveapi.models.components.Security.builder()
              .auth(auth)
              .build());
            return this;
        }
        ...
        public Builder serverURL(String serverUrl, java.util.Map<String, String> params) {
            this.sdkConfiguration.serverUrl = com.prove.proveapi.proveapi.utils.Utils.templateUrl(serverUrl, params);
            return this;
        }
        ...
        void _hooks(com.prove.proveapi.proveapi.utils.Hooks hooks) {
