...
public class V3TokenRequestRequestBuilder {
    ...
    private Optional<? extends com.prove.sdk.proveapi.models.components.V3TokenRequest> request = Optional.empty();
    ...
    public V3TokenRequestRequestBuilder request(com.prove.sdk.proveapi.models.components.V3TokenRequest request) {
        Utils.checkNotNull(request, "request");
        this.request = Optional.of(request);
        return this;
    }

    public V3TokenRequestRequestBuilder request(Optional<? extends com.prove.sdk.proveapi.models.components.V3TokenRequest> request) {
        Utils.checkNotNull(request, "request");
