...
import com.prove.sdk.proveapi.utils.HTTPRequest;
...
import com.prove.sdk.proveapi.utils.JSON;
import com.prove.sdk.proveapi.utils.Retries.NonRetryableException;
import com.prove.sdk.proveapi.utils.SerializedBody;
...
public class V3 implements
     ...
     */
    public com.prove.sdk.proveapi.models.operations.V3ChallengeRequestRequestBuilder v3ChallengeRequest() {
        return new com.prove.sdk.proveapi.models.operations.V3ChallengeRequestRequestBuilder(this);
    }
     ...
     */
    public com.prove.sdk.proveapi.models.operations.V3ChallengeRequestResponse v3ChallengeRequestDirect() throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public com.prove.sdk.proveapi.models.operations.V3ChallengeRequestResponse v3ChallengeRequest(
        ...
        Object _convertedRequest = Utils.convertToShape(request, Utils.JsonShape.DEFAULT,
            new TypeReference<Optional<? extends com.prove.sdk.proveapi.models.components.V3ChallengeRequest>>() {});
        ...
        com.prove.sdk.proveapi.models.operations.V3ChallengeRequestResponse.Builder _resBuilder = 
            com.prove.sdk.proveapi.models.operations.V3ChallengeRequestResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.prove.sdk.proveapi.models.operations.V3ChallengeRequestResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                com.prove.sdk.proveapi.models.components.V3ChallengeResponse _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.prove.sdk.proveapi.models.components.V3ChallengeResponse>() {});
     ...
     * @return The call builder
     */
    public com.prove.sdk.proveapi.models.operations.V3CompleteRequestRequestBuilder v3CompleteRequest() {
        return new com.prove.sdk.proveapi.models.operations.V3CompleteRequestRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.prove.sdk.proveapi.models.operations.V3CompleteRequestResponse v3CompleteRequestDirect() throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public com.prove.sdk.proveapi.models.operations.V3CompleteRequestResponse v3CompleteRequest(
        ...
        HTTPRequest _req = new HTTPRequest(_url, "POST");
        Object _convertedRequest = Utils.convertToShape(request, Utils.JsonShape.DEFAULT,
            new TypeReference<Optional<? extends com.prove.sdk.proveapi.models.components.V3CompleteRequest>>() {});
        SerializedBody _serializedRequestBody = Utils.serializeRequestBody(
                _convertedRequest, "request", "json", false);
        _req.setBody(Optional.ofNullable(_serializedRequestBody));
        _req.addHeader("Accept", "application/json")
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.prove.sdk.proveapi.models.operations.V3CompleteRequestResponse.Builder _resBuilder = 
            com.prove.sdk.proveapi.models.operations.V3CompleteRequestResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.prove.sdk.proveapi.models.operations.V3CompleteRequestResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                com.prove.sdk.proveapi.models.components.V3CompleteResponse _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.prove.sdk.proveapi.models.components.V3CompleteResponse>() {});
    ...
    public com.prove.sdk.proveapi.models.operations.V3StartRequestRequestBuilder v3StartRequest() {
        return new com.prove.sdk.proveapi.models.operations.V3StartRequestRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.prove.sdk.proveapi.models.operations.V3StartRequestResponse v3StartRequestDirect() throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public com.prove.sdk.proveapi.models.operations.V3StartRequestResponse v3StartRequest(
        ...
        HTTPRequest _req = new HTTPRequest(_url, "POST");
        Object _convertedRequest = Utils.convertToShape(request, Utils.JsonShape.DEFAULT,
            new TypeReference<Optional<? extends com.prove.sdk.proveapi.models.components.V3StartRequest>>() {});
        SerializedBody _serializedRequestBody = Utils.serializeRequestBody(
                _convertedRequest, "request", "json", false);
        _req.setBody(Optional.ofNullable(_serializedRequestBody));
        _req.addHeader("Accept", "application/json")
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.prove.sdk.proveapi.models.operations.V3StartRequestResponse.Builder _resBuilder = 
            com.prove.sdk.proveapi.models.operations.V3StartRequestResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.prove.sdk.proveapi.models.operations.V3StartRequestResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                com.prove.sdk.proveapi.models.components.V3StartResponse _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.prove.sdk.proveapi.models.components.V3StartResponse>() {});
    ...
    public com.prove.sdk.proveapi.models.operations.V3ValidateRequestRequestBuilder v3ValidateRequest() {
        return new com.prove.sdk.proveapi.models.operations.V3ValidateRequestRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.prove.sdk.proveapi.models.operations.V3ValidateRequestResponse v3ValidateRequestDirect() throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public com.prove.sdk.proveapi.models.operations.V3ValidateRequestResponse v3ValidateRequest(
        ...
        HTTPRequest _req = new HTTPRequest(_url, "POST");
        Object _convertedRequest = Utils.convertToShape(request, Utils.JsonShape.DEFAULT,
            new TypeReference<Optional<? extends com.prove.sdk.proveapi.models.components.V3ValidateRequest>>() {});
        SerializedBody _serializedRequestBody = Utils.serializeRequestBody(
                _convertedRequest, "request", "json", false);
        _req.setBody(Optional.ofNullable(_serializedRequestBody));
        _req.addHeader("Accept", "application/json")
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.prove.sdk.proveapi.models.operations.V3ValidateRequestResponse.Builder _resBuilder = 
            com.prove.sdk.proveapi.models.operations.V3ValidateRequestResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.prove.sdk.proveapi.models.operations.V3ValidateRequestResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                com.prove.sdk.proveapi.models.components.V3ValidateResponse _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.prove.sdk.proveapi.models.components.V3ValidateResponse>() {});
